...
dataset_config = {
    ...
    'cub200': {
        ...
        'crop': 32,
        'flip': True,
        'normalize': ((0.485, 0.500, 0.432), (0.232, 0.227, 0.266)),
        'class_order': [107,  58,  38,  24,  52,  30,  84, 142,  44, 119,  66,  36,  11,
                        47, 199, 194,   3, 173,  26, 147,  40, 179,  65,  12,  33, 174,
                       186,  74, 112, 170,  28, 192, 145,  21,  62,   4, 196, 143,  43,
                       161,  27,  20,  22,  72, 178, 149,  77,  16,  86,  91, 139, 105,
                       117,  98,  78, 108,  18, 104, 100,  90,  50,  73,  89, 157,  97,
                       159,   2, 130, 188,  85, 160,  53,  69, 144,  81,  25, 138, 110,
                       190,  87, 150,   1, 195,  23,  42, 153,   5, 183,  82, 156,  15,
                        32, 124, 132,   9,  64, 120,  75, 136, 109, 113, 171,  57,  51,
                       191, 175, 166, 165, 111,  96, 141, 146,  79,   6,  41,  56, 180,
                        99, 122, 155,  83,  68, 114, 134, 148,  13,  34,  19,  14, 187,
                        94, 106,  46,  37, 167,  31, 158,  76,  55, 128,  48, 193, 118,
                       184,   0, 154, 162, 182, 197, 133,  63, 163, 172, 101,  61, 121,
                        80,  17, 125, 131, 152, 102,  71,  49, 140, 137, 135,  70, 116,
                        92, 189, 176, 129,  59,  39,   8, 103, 151, 115, 168, 181, 169,
                        93, 198,  95, 127,  60,   7,  67, 185,  88,  10, 164,  35,  54,
                       177,  29, 123, 126,  45]
    },
    'vggface2': {
        'path': join(_BASE_DATA_PATH, 'VGGFace2_Test'),
        'resize': 40,
        'crop': 32,
        'flip': True,
